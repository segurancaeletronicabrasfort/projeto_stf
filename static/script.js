...
// Dentro do bloco "if (isDashboard) { ... }"
const adminLinkWrapper = document.getElementById("adminLinkWrapper");
const adminArea        = document.getElementById("adminArea"); // se existir uma seção de admin no dashboard
...
// Lógica btnAccessAdmninPanel
            if (payload) {
                ...
                // NOVO: Referência ao botão do modal
                const btnAdminPanel = document.getElementById("btnAccessAdminPanel");

                // Lógica de Visibilidade
                if (role === 'admin') {
                    // SE FOR ADMIN:
                    if(adminArea) adminArea.style.display = "block";
                    if(btnAdminPanel) btnAdminPanel.style.display = "block"; // <--- MOSTRA O BOTÃO
                    loadPowerBI(); 
                } else if (role === 'supervisor') {
                    // SE FOR SUPERVISOR:
                    if(adminArea) adminArea.style.display = "none";
                    if(btnAdminPanel) btnAdminPanel.style.display = "none"; // <--- ESCONDE
                    loadPowerBI();
                } else {
                    // SE FOR SOLICITANTE:
                    if(adminArea) adminArea.style.display = "none";
